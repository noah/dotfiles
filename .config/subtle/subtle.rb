...
begin
 SUBTLE_CONFIG_ROOT="#{ENV["HOME"]}/src/subtle-contrib/ruby"
 %w[launcher selector].each{|contribfile| require "#{SUBTLE_CONFIG_ROOT}/#{contribfile}.rb" }
 ...
 Subtle::Contrib::Launcher.fonts = [
   "xft:monaco:pixelsize=8:antialias=true",
   "xft:monaco:pixelsize=8:antialias=true" 
 ]
...
grab "A-1", :ScreenJump1
grab "A-2", :ScreenJump2
grab "A-3", :ScreenJump3
grab "A-4", :ScreenJump4
